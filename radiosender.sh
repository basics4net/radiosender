...
do
   case "$auswahl" in
      End)  echo -e "\n\e[3m powered by \033[1mbasics4net \n" ; tput sgr0 ; echo -e "see \033[1mhttps://basics4net.ch" ; tput sgr0 ; echo -e " or \033[1mhttp://summo.ch\n" ; break ;;
		...
		"Radio Rottu Oberwallis") mpv https://streams.rro.ch/rro.mp3?usid=0-0-H-M-A-01 ;;

		"Swiss Melody") mpv https://streams.rro.ch/swissmelody.mp3?usid=0-0-H-M-A-01 ;;

		"Müsig pur") mpv https://streams.rro.ch/muesigpur.mp3?usid=0-0-H-M-A-01 ;;

		"Walliser Geschichte") mpv https://streams.rro.ch/event.mp3 ;;
